...
const ADMINS = [
  { id: "pablo", name: "Pablo del Campo", short: "PC", color: B.accent },
  { id: "joaquin", name: "Joaquín del Campo", short: "JC", color: B.danger },
];
...
const APPROVAL_HISTORY=[
  { id: 10, title: "Burger del Día martes", brand: "fatty", result: "aprobada", round: 1, date: "05/04", approvedBy: "Joaquín del Campo", kind: "material" },
  { id: 11, title: "Caption Bingo recap", brand: "cheddars", result: "aprobada", round: 1, date: "04/04", approvedBy: "Pablo del Campo", kind: "material" },
  { id: 12, title: "Post San Valentín Cheddar's", brand: "cheddars", result: "aprobada", round: 2, date: "11/02", approvedBy: "Joaquín del Campo", kind: "material" },
  { id: 13, title: "Reel Fiesta Semáforo", brand: "cheddars", result: "aprobada", round: 1, date: "12/02", approvedBy: "Pablo del Campo", kind: "material" },
  { id: 14, title: "Carrusel Fatty Vibes", brand: "fatty", result: "aprobada", round: 1, date: "01/03", approvedBy: "Joaquín del Campo", kind: "material" },
  { id: 20, title: "Fatty — Desconfianza (grilla)", brand: "fatty", result: "aprobada", round: 1, date: "28/03", approvedBy: "Joaquín del Campo", kind: "idea" },
  { id: 21, title: "Cheddar's — Martes de Amigas (grilla)", brand: "cheddars", result: "aprobada", round: 1, date: "30/03", approvedBy: "Pablo del Campo", kind: "idea" },
];
          ...
          {pendGate === "material" && (
            <div>
              ...
              <Card style={{ marginTop: 4, background: B.infoBg, border: `1px solid ${B.info}25` }}>
                <div style={{ fontSize: 13, color: B.text, lineHeight: 1.55 }}>
                  {`🎨 Las tareas aparecen aquí cuando el equipo las mueve a 'En revisión' en el tablero de Tareas (2da puerta). Joaquín del Campo o Pablo del Campo aprueban el material producido.`}
                </div>
              </Card>
            </div>
          )}
              ...
              {t.isExperience ? (
                ...
                <>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderTop: `1px solid ${B.border}` }}>
                    ...
                    <span style={{ fontSize: 13, fontWeight: 700, color: t.avgIdeaToPublish <= 5 ? B.success : B.warning }}>{t.avgIdeaToPublish}</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderTop: `1px solid ${B.border}` }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderTop: `1px solid ${B.border}` }}>
                    <span style={{ fontSize: 11, color: B.textMuted }}>% efem. aprobadas</span>
                    <span style={{ fontSize: 13, fontWeight: 700, color: t.ephemerisApprovedPct >= 70 ? B.success : B.warning }}>{t.ephemerisApprovedPct}%</span>
                  </div>
                </>
              ) : (
                <>
